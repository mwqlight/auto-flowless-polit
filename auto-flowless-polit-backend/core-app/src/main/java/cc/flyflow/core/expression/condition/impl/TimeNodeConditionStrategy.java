 ...
 */
@Component
public class TimeNodeConditionStrategy implements NodeConditionStrategy, InitializingBean {
    /**
     * 抽象方法 处理表达式
     */
    @Override
    public String handleExpression(Condition condition) {
        ...
        return StrUtil.format("(expressionHandler.dateTimeHandler(\"{}\",\"{}\",\"{}\",execution,\"HH:mm:ss\"))", id,
                compare,
                value);
    ...
    public boolean handleResult(Condition condition, Map<String, Object> paramMap, String tenantId) {
        ...
        return bean.dateTimeHandler(id,compare,value,paramMap.get(id),"HH:mm:ss");
    }
