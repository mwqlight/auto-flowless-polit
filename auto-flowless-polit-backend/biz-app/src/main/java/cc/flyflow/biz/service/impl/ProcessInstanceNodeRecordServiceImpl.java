...
import cc.flyflow.biz.mapper.ProcessInstanceNodeRecordMapper;
...
public class ProcessInstanceNodeRecordServiceImpl extends ServiceImpl<ProcessInstanceNodeRecordMapper, ProcessInstanceNodeRecord>
    ...
    public R startNodeEvent(ProcessInstanceNodeRecordParamDto processInstanceNodeRecordParamDto) {
        ...
        //设置来源的上级id
        String lastNodeId = cc.flyflow.biz.utils.NodeUtil.getLastNodeId(flowId, nodeId, parentNodeId);
        ...
        //设置executionId
        cc.flyflow.biz.utils.NodeUtil.handleNodeAddExecutionId(currentProcessRootNode,
                nodeId,
                processInstanceNodeRecordParamDto.getExecutionId()
        );
