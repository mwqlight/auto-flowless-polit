...
@Component
public class MultiSelectFormStrategyImpl implements InitializingBean, FormStrategy {
    @Override
    ...
    public boolean isBlank(Object value, FormItemVO formItemVO, Map<String, Object> paramMap) {
        ...
        List<SelectValue> nodeUserList = JsonUtil.parseArray(JsonUtil.toJSONString(value), SelectValue.class);
